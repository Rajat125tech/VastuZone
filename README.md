...
VastuZone is a full-stack web application that enables users to analyze property Vastu compliance, book expert consultations, and make secure payments — all in one seamless platform.The system combines rule-based Vastu logic, real-time chat, appointment scheduling, and payment gateway integration to deliver a complete digital consultation experience.
